                    ...
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 text-sm text-slate-500">
                        ...
                        {app.resumeName && (
                            <div className="flex items-center gap-2 text-blue-600 hover:underline cursor-pointer">
                                <FileText size={16}/> {app.resumeName}
                            </div>
                        )}
                    </div>
                        ...
                        {app.status === "Applied" ? (
                            <>
                                <button 
                                    ...
                                    className="flex-1 lg:flex-none px-4 py-2 rounded-lg border border-red-200 text-red-600 hover:bg-red-50 dark:border-red-900/50 dark:hover:bg-red-900/20 font-medium transition-colors"
                                >
                                    Reject
                                </button>
                                <button 
                                    onClick={() => openAcceptModal(app)}
                                    className="flex-1 lg:flex-none px-6 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 shadow-lg shadow-blue-600/20 font-medium transition-colors"
                                >
                                    Shortlist & Interview
                                </button>
                            </>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                    ...
                    >
                        ...
                        <form onSubmit={submitAccept} className="p-6 space-y-4">
                            ...
                            <button disabled={processing} className="w-full py-3 bg-green-600 text-white font-bold rounded-xl hover:bg-green-700 transition-colors flex items-center justify-center gap-2">
